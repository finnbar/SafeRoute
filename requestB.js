...
var carCrime = ["all-crime","other-theft","possession-of-weapons","public-order","robbery","vehicle-crime","other-crime"];
...
request(
  { method: 'GET'
  , json: true
  , uri: 'http://data.police.uk/api/crimes-street/all-crime?poly=52.40681980,-1.51970930:52.40681979,-1.51970930:52.40681979,-1.51970929:52.40681980,-1.51970929 + '&date=' + yr + '-' + mnth},
  function (err, data) {
